 ...
 *
 * Donnees confidentielles masquees avec *
 */

define( "IS_INCLUDED", true );
define( "TFTP_HOST", "192.168.1.1" );
define( "TFTP_FTP_USERNAME", "fog" );	#Info de l'utilisateur linux fog pour connexion ftp
define( "TFTP_FTP_PASSWORD", "71fog" );
...
define( "STORAGE_FTP_PASSWORD", "71fog" );
...
define( "MYSQL_DATABASE", "fog" );			#Info pour la connexion à la base de donnee
